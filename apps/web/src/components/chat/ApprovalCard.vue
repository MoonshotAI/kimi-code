...
// height instead. The cap follows the VISUAL viewport (mirroring App.vue's
// setAppHeight): window.innerHeight does not shrink when the iOS keyboard
// opens, so a cap measured against it would exceed the visible area and get
// clipped by .app-shell's overflow: hidden.
