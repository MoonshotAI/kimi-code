...
// their bridge-resolved paths here). Web has no desktop bridge, so a dropped
// or pasted folder never resolves a path and this is simply never called —
// folders stay ignored, same as before.
// ---------------------------------------------------------------------------
