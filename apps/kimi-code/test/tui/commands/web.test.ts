...
const mocks = vi.hoisted(() => ({
  ...
  t: (key: string, params?: Record<string, string | number>) => {
    const translations: Record<string, string> = {
      'tui.statusMessages.webNewServer': 'Start a new server',
      'tui.statusMessages.webNewServerDesc': 'Run a new server in the foreground on this terminal after the TUI exits (stop with Ctrl+C), then open the session deep link in your browser.',
      'tui.statusMessages.webServerNotResponding': 'Kimi server at {{origin}} is not responding.',
      'tui.statusMessages.webVersionUnknown': 'version unknown (registered by an older build) · id {{id}}',
      'tui.statusMessages.webVersionMismatch': 'version {{hostVersion}} (this CLI: {{cliVersion}}) · id {{id}}',
      'tui.statusMessages.webVersion': 'version {{hostVersion}} · id {{id}}',
      'tui.statusMessages.webSessionLabel': 'Session:  ',
      'tui.statusMessages.webOpenUrl': 'open {{url}}',
      'tui.statusMessages.webToken': 'Token:    {{token}}',
      'tui.statusMessages.openInWebUi': 'Open in Web UI',
    };
