...
import {
  RuntimeCwdDialogComponent,
  type RuntimeCwdDialogOptions,
} from '#/tui/components/dialogs/runtime-cwd-dialog';
...
function rendered(component: RuntimeCwdDialogComponent, width = 80): string {
  return component.render(width).join('\n').replaceAll(SGR, '');
}

function makeDialog(overrides: Partial<RuntimeCwdDialogOptions> = {}): RuntimeCwdDialogComponent {
...
describe('RuntimeCwdDialogComponent', () => {
