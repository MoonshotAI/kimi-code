 ...
 * (gated by `KIMI_CODE_EXPERIMENTAL_FLAG`). Both the v1 `KimiHarness` / `Session`
 * and the v2 path structurally satisfy these interfaces, so no adapter wrappers
 * are needed on the v1 path.
 */
