export default {
  ...
  tui: {
    ...
    statusMessages: {
      ...
      // commands/prompts.ts & provider.ts
      selectProviderToLogout: 'Select a provider to log out',
      feedbackNoAttachment: 'No attachment',
      feedbackNoAttachmentDesc: 'Only send the feedback message.',
      feedbackLogsOnly: 'Logs',
      feedbackLogsOnlyDesc: 'Include recent logs.',
      feedbackLogsAndCodebase: 'Logs + codebase',
      feedbackLogsAndCodebaseDesc: 'Include recent logs and info about the active codebase.',
      shareDiagnosticInfo: 'Share diagnostic info',
      apiKeySavedTo: 'API key saved for {{provider}}.',
      catalogNoSupportedProviders: 'No supported providers in the catalog.',
      ...
      customRegistryOption: 'Custom registry',
      fetchingCatalog: 'Fetching catalog from {url}...',
      catalogLoaded: 'Catalog loaded.',
      catalogAborted: 'Aborted.',
      catalogFailedToLoad: 'Failed to load catalog.',
      catalogFetchFailed: 'Failed to fetch catalog{hint}: {error}',
      providerNoUsableModels: 'Provider "{providerId}" has no usable models in this catalog.',
      providerUnsupportedWire: 'Provider "{providerId}" has an unsupported wire type in the catalog.',
      providerAdded: 'Added {providerName} ({providerId}).',
      setDefaultModelFailed: 'Failed to set default model: {error}',
      defaultModelSet: 'Default model set to {alias} ({effort}).',
      failedToImportRegistry: 'Failed to import registry: {error}',
      failedToApplyRegistry: 'Failed to apply registry: {error}',
      registryNoProviders: 'No providers in registry.',
