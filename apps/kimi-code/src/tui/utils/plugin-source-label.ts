 ...
 * source — a zip download under the official CDN plugin path (or the loopback
 * dev mirror). Local paths, GitHub repos, and third-party URLs do not qualify,
 * even when their manifest id matches an official plugin.
 */
