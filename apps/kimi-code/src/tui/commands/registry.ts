...
export const BUILTIN_SLASH_COMMANDS = [
  ...
  },
  {
    name: 'add-dir',
    aliases: [],
    description: 'Add a directory to the current session',
  ...
  },
  {
    name: 'dirs',
    aliases: ['directories'],
    description: 'Show directories in the current session',
    priority: 80,
    availability: 'always',
  },
  {
    name: 'remove-dir',
    aliases: ['rm-dir'],
    description: 'Remove an extra directory from the current session',
    argumentHint: '<directory>',
    priority: 80,
    availability: 'always',
  },
