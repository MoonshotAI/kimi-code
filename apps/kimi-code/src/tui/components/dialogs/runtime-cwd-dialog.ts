/**
 * RuntimeCwdDialogComponent — single-field rounded box collecting the remote
 * working directory for a runtime switch (experimental remote runtime).
 *
...
export interface RuntimeCwdDialogOptions {
...
export class RuntimeCwdDialogComponent extends Container implements Focusable {
  focused = false;
  ...
  constructor(private readonly opts: RuntimeCwdDialogOptions) {
    super();
