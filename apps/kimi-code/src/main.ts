...
function bootstrap(): void {
  ...
  // actually used is decided inside packages/oauth (the credentials_store
  // config, KIMI_DISABLE_KEYRING, and a capability probe); a load failure
  // only warns and the file store stays in charge.
