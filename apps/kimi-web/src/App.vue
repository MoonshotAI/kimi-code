...
<template>
  <div class="app-shell">
    ...
    <ConversationPane
      ...
      :passwords="client.pendingPasswords.value"
      :pending-password-actions="client.pendingPasswordActions"
      :running="running"
      ...
      @password-submit="(passwordId, password) => client.respondPassword(passwordId, { password })"
      @password-cancel="(passwordId) => client.respondPassword(passwordId, { cancelled: true })"
