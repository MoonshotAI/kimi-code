  ...
  <div class="app-shell">
    ...
    <section v-if="showAuthGate" class="auth-page">
      <div class="auth-page-inner">
        <svg ref="authLogoRef" class="auth-page-logo ch-logo" viewBox="0 0 32 22" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" :aria-label="$t('sidebar.brand')" @mousedown.prevent @click="blinkAuthLogo">
          <defs>
