export default {
  ...
  statusNone: '—',
  // Usage limits panel (context ring popover)
  usageTitle: 'Usage',
  usageLoading: 'Loading…',
  usageUnavailable: 'Usage limits unavailable',
  usageRouteUnavailable: 'This backend does not support usage limits',
  usageNotLoggedIn: 'Log in to view usage limits',
  usageEmpty: 'No usage limits to display',
  usageExtraTitle: 'Extra usage',
  usageBalance: 'Balance',
  usageMonthlyUsed: 'Used this month',
  usageMonthlyLimit: 'Monthly limit',
  usageUnlimited: 'Unlimited',
  usageWeekly: 'Weekly limit',
  usageWindowLimit: '{duration} limit',
  usageResetsIn: 'resets in {duration}',
  usageResetNow: 'reset',
  usageDurationDay: '{n}d',
  usageDurationHour: '{n}h',
  usageDurationMinute: '{n}m',
  usageDurationSecond: '{n}s',
