export default {
  ...
  account: '账户',
  kimiCodeAccount: 'Kimi Code',
  chatGptAccount: 'OpenAI ChatGPT Plus/Pro',
  accountAuthenticated: '已登录',
  accountUnauthenticated: '需要重新登录',
  accountMembershipRequired: '未开通 Kimi Code 会员权益',
  signInAnotherAccount: '登录其他账号',
  uiFontSize: '字体大小',
