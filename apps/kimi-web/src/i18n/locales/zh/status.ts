export default {
  ...
  usageRouteUnavailable: '当前后端不支持用量查询',
  usageNotLoggedIn: '登录后可查看用量限制',
  usageEmpty: '暂无可显示的用量限制',
  usageExtraTitle: '额外用量',
  usageBalance: '余额',
  usageMonthlyUsed: '本月已用',
  usageMonthlyLimit: '月度上限',
  usageUnlimited: '不限',
  usageWeekly: '周限额',
  usageWindowLimit: '{duration}限额',
  usageResetsIn: '{duration}后重置',
  usageResetNow: '已重置',
  usageDurationDay: '{n} 天',
  usageDurationHour: '{n} 小时',
  usageDurationMinute: '{n} 分钟',
  usageDurationSecond: '{n} 秒',
  activityRunning: '运行中…',
