  ...
  <div class="ds-page">
    ...
    <div class="layout">
      ...
      ui-monospace, "SF Mono", Menlo, Consolas, monospace;</pre></div>
            ...
            <p>Currently registered icons, grouped by purpose. The display order and grouping are defined by <code>ICON_GROUPS</code> in <code>lib/icons.ts</code> (sourced from the <code>NAME_TO_REMIX</code> mapping), and this catalog is rendered directly from that array so the registry and the document never drift.</p>
            <div class="icon-grid">
