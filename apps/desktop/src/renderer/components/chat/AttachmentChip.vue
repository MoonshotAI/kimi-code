...
<!-- One attachment rendered as a pill chip — used for FILE attachments in
     both the composer's pending-attachment strip and sent messages
     (images/videos render as MediaThumb thumbnails in both places). Context
