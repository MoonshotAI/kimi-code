          ...
          <section id="dialogs">
            ...
            <table class="dt">
              ...
              <tbody>
                ...
                <tr><td class="tk">App update (desktop)</td><td>padded · lg · auto</td><td>version title + quiet meta line (release date · current version) + height-capped scrolling what's-new list / progress bar + right-aligned foot (skip → download, later → restart)</td></tr>
