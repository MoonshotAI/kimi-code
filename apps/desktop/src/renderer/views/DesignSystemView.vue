    ...
    export function auth(token: string) {
      return verify(token, process.env.JWT_SECRET!);
          ...
          <section id="chat">
            ...
            <p><b>Mention &amp; attachment pills</b>: @-mentions and file/folder attachments render as inline pills in the editor — the two elements of the cross-surface rich-text vocabulary specified in §05 <b>Rich Text Messages</b> (visual recipes, wire forms, and behavior contracts live there).</p>
            <div class="stage-wrap">
