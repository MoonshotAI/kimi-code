...
/* =====================================================================
  ...
  .p-code-block pre { margin: 0; padding: var(--space-2) var(--space-3); font-family: var(--p-font-mono); font-size: var(--p-font-size-sm); line-height: var(--leading-normal); color: var(--p-text); overflow-x: auto; }
