...
import { collapseWhitespaceWithMap, findMatchesInSegments, findOccurrences, foldCaseWithMap, isFindKeyEvent, whitespaceModeOf } from '../../src/renderer/lib/transcriptSearch';
