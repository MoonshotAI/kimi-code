...
| `--add-dir <dir>` | | Add another directory to this session's workspace scope. The current directory remains the primary working directory. Can be repeated |
...
Add another repository or package directory to the session's workspace scope:
