...
| `/desktop` | `/install-desktop` | Open the Kimi Code desktop app page (`https://www.kimi.com/code`) in your browser. See [`kimi install-app`](./kimi-command.md#kimi-install-app) | Yes |
