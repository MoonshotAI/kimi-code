...
| `/secondary_model` | — | Pick the default model for subagents (writes `[subagent] default_model`; see the [subagent model pool](../configuration/config-files.md#subagent-model-pool)) | Yes |
