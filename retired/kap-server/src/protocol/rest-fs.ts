...
/**
 * Locally-owned fs wire schemas (stage 4: protocol localisation) — copied
 * from the v2 sessionFs/fs domain so kap-server no longer imports it.
 */
export { isoDateTimeSchema };
export const fsGitStatusSchema = z.object({
  file_path: z.string(),
  status: z.string(),
});
