// @moonshot-ai/web-markdown — self-contained clipboard helper.
//
// Kept inside the package (rather than imported from the host app) so the
// renderer has no reverse dependency on the host. It is intentionally a small,
// stable wrapper around the browser Clipboard API with a legacy fallback.
//
