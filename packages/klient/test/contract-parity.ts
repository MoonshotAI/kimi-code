...
import type { IAgentPromptChannel } from '@moonshot-ai/agent-core-v2/agent/loop/promptChannel';
...
type PromptPayload = Parameters<IAgentPromptChannel['submit']>[0];
type PromptLaunchResult = NonNullable<Awaited<ReturnType<IAgentPromptChannel['submit']>>>;
type SteerPayload = Parameters<IAgentPromptChannel['submitSteer']>[0];
