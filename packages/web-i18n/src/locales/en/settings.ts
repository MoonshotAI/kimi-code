export default {
  ...
  notifyOnCompleteHint: 'Send a system notification when a turn completes',
  notifyOnQuestion: 'Notify when a question needs an answer',
  notifyOnQuestionHint: 'Send a system notification when a question needs your answer',
  notifyOnApproval: 'Notify when a tool needs approval',
  notifyOnApprovalHint: 'Send a system notification when a tool needs approval',
  soundOnComplete: 'Play a sound when a turn completes, needs an answer, or needs approval',
  soundOnCompleteHint: 'Play a sound when a turn needs your attention',
