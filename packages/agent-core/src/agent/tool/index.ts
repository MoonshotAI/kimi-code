  ...
  initializeBuiltinTools() {
    ...
    this.builtinTools = new Map(
      [
        ...
        this.agent.review && new b.GetCommentsTool(this.agent.review),
        this.agent.review && new b.GetCommentEvidenceTool(this.agent.review),
        this.agent.review && new b.MergeCommentsTool(this.agent.review),
        this.agent.review && new b.DismissCommentTool(this.agent.review),
        ...
        this.agent.reviewFanOut && new b.RunCodeReviewTool(this.agent.reviewFanOut),
