...
export const EMBEDDED_SYSTEMS_SKILL = makeBuiltin(
  ...
  {},
  {
    'references/communication-protocols.md':
      EMBEDDED_SYSTEMS_REFERENCES_COMMUNICATION_PROTOCOLS,
    'references/memory-optimization.md':
      EMBEDDED_SYSTEMS_REFERENCES_MEMORY_OPTIMIZATION,
    'references/microcontroller-programming.md':
      EMBEDDED_SYSTEMS_REFERENCES_MICROCONTROLLER_PROGRAMMING,
    'references/power-optimization.md':
      EMBEDDED_SYSTEMS_REFERENCES_POWER_OPTIMIZATION,
