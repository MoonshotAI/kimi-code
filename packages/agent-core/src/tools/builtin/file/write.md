...
- Do not create documentation files (`*.md`) or `README`s unless the user explicitly asks for them — the plan-mode plan file is exempt (create it with Write when plan mode directs you to).
