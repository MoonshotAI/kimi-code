export const zh = {
  ...
  v2Loop: {
    cachePrefixDivergenceSystemPrompt: '提示缓存前缀变更：system prompt 被重写。',
    cachePrefixDivergenceTools: '提示缓存前缀变更：工具定义被重写。',
    cachePrefixDivergenceMessages: '提示缓存前缀变更：消息历史在第 {{messageIndex}} 条处被重写。',
  },
} as const;
