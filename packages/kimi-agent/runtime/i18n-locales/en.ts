export const en = {
  ...
  v2Loop: {
    cachePrefixDivergenceSystemPrompt: 'Prompt cache prefix changed: system prompt was rewritten.',
    cachePrefixDivergenceTools: 'Prompt cache prefix changed: tool definitions were rewritten.',
    cachePrefixDivergenceMessages:
      'Prompt cache prefix changed: message history was rewritten at index {{messageIndex}}.',
  },
} as const;
