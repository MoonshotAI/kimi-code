import { emptyUsage, modelKey, type LlmModel, type TokenUsage } from '@moonshot-ai/agent-core';
  ...
  return {
    ...
    byModel:
      record.model === undefined
        ...
        : {
            ...summary.byModel,
            [modelKey(record.model)]: addUsage(summary.byModel[modelKey(record.model)], record.usage),
          },
    byTurn:
