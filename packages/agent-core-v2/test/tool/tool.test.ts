  ...
  describe('registered user tools', () => {
    ...
    it('routes registered user tools through tool.call request/response', async () => {
      ...
      expect(
        ...
        [emit] agent.status.updated        { "time": "<time>", "contextTokens": 5, "rawContextTokens": 5 }
        ...
        [emit] agent.status.updated        { "time": "<time>", "contextTokens": 140, "rawContextTokens": 140 }
        ...
        [wire] usage.record                { "model": "mock-model", "usage": { "inputOther": 140, "output": 21, "inputCacheRead": 0, "inputCacheCreation": 0 }, "usageScope": "turn", "time": "<time>" }
        [emit] agent.status.updated        { "time": "<time>", "usage": { "byModel": { "mock-model": { "inputOther": 140, "output": 21, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 140, "output": 21, "inputCacheRead": 0, "inputCacheCreation": 0 }, "currentTurn": { "inputOther": 140, "output": 21, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
        [wire] token_counting.measured     { "length": 3, "tokens": 161, "time": "<time>" }
        [emit] agent.status.updated        { "time": "<time>", "contextTokens": 161 }
        [emit] agent.status.updated        { "time": "<time>", "contextTokens": 161, "rawContextTokens": 164 }
      ...
      expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
        ...
        [emit] turn.step.completed         { "time": "<time>", "turnId": 0, "step": 1, "stepId": "<uuid-1>", "usage": { "inputOther": 140, "output": 21, "inputCacheRead": 0, "inputCacheCreation": 0 }, "finishReason": "tool_use", "providerFinishReason": "tool_calls", "rawFinishReason": "tool_calls" }
        [wire] context.append_loop_event   { "event": { "type": "step.end", "uuid": "<uuid-1>", "turnId": "0", "step": 1, "finishReason": "tool_use", "usage": { "inputOther": 140, "output": 21, "inputCacheRead": 0, "inputCacheCreation": 0 }, "messageId": "mock-1", "providerFinishReason": "tool_calls", "rawFinishReason": "tool_calls" }, "time": "<time>" }
        ...
        [emit] agent.status.updated        { "time": "<time>", "usage": { "byModel": { "mock-model": { "inputOther": 306, "output": 33, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 306, "output": 33, "inputCacheRead": 0, "inputCacheCreation": 0 }, "currentTurn": { "inputOther": 306, "output": 33, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
        [wire] token_counting.measured     { "length": 5, "tokens": 178, "time": "<time>" }
        [emit] agent.status.updated        { "time": "<time>", "contextTokens": 178 }
        [emit] agent.status.updated        { "time": "<time>", "contextTokens": 178, "rawContextTokens": 181 }
        [emit] turn.step.completed         { "time": "<time>", "turnId": 0, "step": 2, "stepId": "<uuid-4>", "usage": { "inputOther": 166, "output": 12, "inputCacheRead": 0, "inputCacheCreation": 0 }, "finishReason": "end_turn", "providerFinishReason": "completed", "rawFinishReason": "stop" }
        [emit] agent.activity.updated      { "time": "<time>", "lifecycle": "ready", "turn": { "turnId": 0, "origin": { "kind": "user" }, "phase": "running", "step": 2, "ending": false, "pendingApprovals": [], "activeToolCalls": [], "since": "<time>" }, "background": [] }
    ...
    `);
      ...
      expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
        ...
        [emit] agent.status.updated         { "time": "<time>", "contextTokens": 186, "rawContextTokens": 186 }
        ...
        [wire] usage.record                 { "model": "mock-model", "usage": { "inputOther": 186, "output": 11, "inputCacheRead": 0, "inputCacheCreation": 0 }, "usageScope": "turn", "time": "<time>" }
        [emit] agent.status.updated         { "time": "<time>", "usage": { "byModel": { "mock-model": { "inputOther": 492, "output": 44, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 492, "output": 44, "inputCacheRead": 0, "inputCacheCreation": 0 }, "currentTurn": { "inputOther": 186, "output": 11, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
        [wire] token_counting.measured      { "length": 7, "tokens": 197, "time": "<time>" }
        [emit] agent.status.updated         { "time": "<time>", "contextTokens": 197 }
        [emit] agent.status.updated         { "time": "<time>", "contextTokens": 197, "rawContextTokens": 200 }
        [emit] turn.step.completed          { "time": "<time>", "turnId": 1, "step": 1, "stepId": "<uuid-6>", "usage": { "inputOther": 186, "output": 11, "inputCacheRead": 0, "inputCacheCreation": 0 }, "finishReason": "end_turn", "providerFinishReason": "completed", "rawFinishReason": "stop" }
        [emit] agent.activity.updated       { "time": "<time>", "lifecycle": "ready", "turn": { "turnId": 1, "origin": { "kind": "user" }, "phase": "running", "step": 1, "ending": false, "pendingApprovals": [], "activeToolCalls": [], "since": "<time>" }, "background": [] }
        ...
        [wire] context.append_loop_event    { "event": { "type": "step.end", "uuid": "<uuid-6>", "turnId": "1", "step": 1, "finishReason": "end_turn", "usage": { "inputOther": 186, "output": 11, "inputCacheRead": 0, "inputCacheCreation": 0 }, "messageId": "mock-3", "providerFinishReason": "completed", "rawFinishReason": "stop" }, "time": "<time>" }
