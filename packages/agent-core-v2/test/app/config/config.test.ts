...
describe('Agent config', () => {
  ...
  it('keeps turn-start config for later steps and applies updates to the next turn', async () => {
    ...
    expect(await ctx.untilApproval(true)).toMatchInlineSnapshot(`
      ...
      [wire] turn.started                    { "agentId": "main", "turnId": 0, "promptId": "<msg-1>", "origin": { "kind": "user" }, "input": [ { "type": "text", "text": "Look up before config changes" } ], "time": "<time>" }
      [emit] turn.started                    { "time": "<time>", "agentId": "main", "turnId": 0, "promptId": "<msg-1>", "origin": { "kind": "user" }, "input": [ { "type": "text", "text": "Look up before config changes" } ] }
      [emit] context.spliced                 { "time": "<time>", "agentId": "main", "start": 0, "deleteCount": 0, "messages": [ { "message": { "role": "user", "content": [ { "type": "text", "text": "Look up before config changes" } ] }, "meta": { "promptId": "<msg-1>", "origin": { "kind": "user" } } } ] }
      [emit] prompt.started                  { "time": "<time>", "agentId": "main", "promptId": "<msg-1>" }
      [wire] context.append_message          { "agentId": "main", "message": { "message": { "role": "user", "content": [ { "type": "text", "text": "Look up before config changes" } ] }, "meta": { "promptId": "<msg-1>", "origin": { "kind": "user" } } }, "time": "<time>" }
    ...
    expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
      ...
      [emit] context.spliced             { "time": "<time>", "agentId": "main", "start": 3, "deleteCount": 0, "messages": [ { "message": { "role": "user", "content": [ { "type": "text", "text": "<date-reminder>", "contentType": "text/xml" } ] }, "meta": { "origin": { "kind": "injection", "variant": "date_change", "disclosure": { "kind": "date", "renderGeneration": 2, "localDate": "<date>", "timeZone": "<time-zone>" } } } } ] }
      [wire] context.append_message      { "agentId": "main", "message": { "message": { "role": "user", "content": [ { "type": "text", "text": "<date-reminder>", "contentType": "text/xml" } ] }, "meta": { "origin": { "kind": "injection", "variant": "date_change", "disclosure": { "kind": "date", "renderGeneration": 2, "localDate": "<date>", "timeZone": "<time-zone>" } } } }, "time": "<time>" }
    ...
    expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
      ...
      [wire] turn.started                   { "agentId": "main", "turnId": 1, "promptId": "<msg-2>", "origin": { "kind": "user" }, "input": [ { "type": "text", "text": "Start a fresh turn" } ], "time": "<time>" }
      [emit] turn.started                   { "time": "<time>", "agentId": "main", "turnId": 1, "promptId": "<msg-2>", "origin": { "kind": "user" }, "input": [ { "type": "text", "text": "Start a fresh turn" } ] }
      [emit] context.spliced                { "time": "<time>", "agentId": "main", "start": 5, "deleteCount": 0, "messages": [ { "message": { "role": "user", "content": [ { "type": "text", "text": "Start a fresh turn" } ] }, "meta": { "promptId": "<msg-2>", "origin": { "kind": "user" } } } ] }
      [emit] prompt.started                 { "time": "<time>", "agentId": "main", "promptId": "<msg-2>" }
      [wire] context.append_message         { "agentId": "main", "message": { "message": { "role": "user", "content": [ { "type": "text", "text": "Start a fresh turn" } ] }, "meta": { "promptId": "<msg-2>", "origin": { "kind": "user" } } }, "time": "<time>" }
