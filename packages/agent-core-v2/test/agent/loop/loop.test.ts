...
describe('Agent loop', () => {
  ...
  it('runs a text-only agent turn from prompt to completion', async () => {
    ...
    expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
      ...
      [emit] agent.status.updated        { "time": "<time>", "contextTokens": 3, "rawContextTokens": 3 }
      ...
      [emit] agent.status.updated        { "time": "<time>", "usage": { "byModel": { "mock-model": { "inputOther": 3, "output": 10, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 3, "output": 10, "inputCacheRead": 0, "inputCacheCreation": 0 }, "currentTurn": { "inputOther": 3, "output": 10, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      [wire] token_counting.measured     { "length": 2, "tokens": 13, "time": "<time>" }
      [emit] agent.status.updated        { "time": "<time>", "contextTokens": 13 }
      [emit] agent.status.updated        { "time": "<time>", "contextTokens": 13, "rawContextTokens": 16 }
      [emit] turn.step.completed         { "time": "<time>", "turnId": 0, "step": 1, "stepId": "<uuid-1>", "usage": { "inputOther": 3, "output": 10, "inputCacheRead": 0, "inputCacheCreation": 0 }, "finishReason": "end_turn", "providerFinishReason": "completed", "rawFinishReason": "stop" }
      [emit] agent.activity.updated      { "time": "<time>", "lifecycle": "ready", "turn": { "turnId": 0, "origin": { "kind": "user" }, "phase": "running", "step": 1, "ending": false, "pendingApprovals": [], "activeToolCalls": [], "since": "<time>" }, "background": [] }
      ...
      [wire] context.append_loop_event   { "event": { "type": "step.end", "uuid": "<uuid-1>", "turnId": "0", "step": 1, "finishReason": "end_turn", "usage": { "inputOther": 3, "output": 10, "inputCacheRead": 0, "inputCacheCreation": 0 }, "messageId": "mock-1", "providerFinishReason": "completed", "rawFinishReason": "stop" }, "time": "<time>" }
  ...
  it('fails the turn after a filtered step completes', async () => {
    ...
    expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
      ...
      [emit] agent.status.updated        { "time": "<time>", "contextTokens": 8, "rawContextTokens": 11 }
  ...
  it('runs an agent turn through registered tool approval and execution', async () => {
    ...
    expect(await ctx.untilApproval(true)).toMatchInlineSnapshot(`
      ...
      [emit] agent.status.updated            { "time": "<time>", "usage": { "byModel": { "mock-model": { "inputOther": 5, "output": 21, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 5, "output": 21, "inputCacheRead": 0, "inputCacheCreation": 0 }, "currentTurn": { "inputOther": 5, "output": 21, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      [wire] token_counting.measured         { "length": 2, "tokens": 26, "time": "<time>" }
      [emit] agent.status.updated            { "time": "<time>", "contextTokens": 26 }
      [emit] agent.status.updated            { "time": "<time>", "contextTokens": 26, "rawContextTokens": 29 }
    ...
    expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
      ...
      [emit] turn.step.completed                 { "time": "<time>", "turnId": 0, "step": 1, "stepId": "<uuid-1>", "usage": { "inputOther": 5, "output": 21, "inputCacheRead": 0, "inputCacheCreation": 0 }, "finishReason": "tool_use", "providerFinishReason": "tool_calls", "rawFinishReason": "tool_calls" }
      [wire] context.append_loop_event           { "event": { "type": "step.end", "uuid": "<uuid-1>", "turnId": "0", "step": 1, "finishReason": "tool_use", "usage": { "inputOther": 5, "output": 21, "inputCacheRead": 0, "inputCacheCreation": 0 }, "messageId": "mock-1", "providerFinishReason": "tool_calls", "rawFinishReason": "tool_calls" }, "time": "<time>" }
      ...
      [emit] agent.status.updated                { "time": "<time>", "usage": { "byModel": { "mock-model": { "inputOther": 36, "output": 34, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 36, "output": 34, "inputCacheRead": 0, "inputCacheCreation": 0 }, "currentTurn": { "inputOther": 36, "output": 34, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      [wire] token_counting.measured             { "length": 4, "tokens": 44, "time": "<time>" }
      [emit] agent.status.updated                { "time": "<time>", "contextTokens": 44 }
      [emit] agent.status.updated                { "time": "<time>", "contextTokens": 44, "rawContextTokens": 47 }
