...
import { AgentGoal, GoalRuntime } from '#/actor/goal/goalAgentRuntime';
...
import { GoalUpdated } from '#/actor/goal/goalOps';
...
import type { PermissionMode, PermissionPolicyResult } from '#/actor/toolExecutor/permissionTypes';
