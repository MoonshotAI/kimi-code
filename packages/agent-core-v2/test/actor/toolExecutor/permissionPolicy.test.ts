...
import {
  ToolExecutionPermissionPolicyChain,
  type PermissionPolicyEvaluation,
} from '#/actor/toolExecutor/internal/permissionPolicy';
...
describe('ToolExecutionPermissionPolicyChain', () => {
...
describe('ToolExecutionPermissionPolicyChain git cwd write approval', () => {
  let disposables: DisposableStore;
  let ix: TestInstantiationService;
  let mode: PermissionMode;
  let workspace: ReturnType<typeof workspaceStub>;
