...
import { compileToolArgsValidator, validateToolArgs } from '#/_base/tools/args-validator';

function validate(schema: Record<string, unknown>, value: unknown): string | null {
