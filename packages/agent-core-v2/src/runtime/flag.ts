...
export const remoteRuntimeFlag: FlagDefinitionInput = {
  ...
  description:
    'Allow binding sessions to remote runtimes (SSH hosts and containers) declared in config, so agent tools execute in the target environment instead of the local machine.',
