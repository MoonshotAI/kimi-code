 ...
 * degraded media is still too large or an image format / non-text
 * content-type is rejected, so a newly generated recovery image remains
 * visible on later steps. Both are read-side only — the history keeps its
 * media.
 */
