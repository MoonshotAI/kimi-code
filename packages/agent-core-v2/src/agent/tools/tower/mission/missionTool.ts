...
import { MISSIONS_DIR, missionFileName } from '#/agent/tower/protocol/index';
import type { TowerMission, TowerStore } from '#/agent/tower/protocol/index';
...
registerAgentToolService(ITowerMissionTool, TowerMissionTool, {
  name: 'TowerMission',
  domain: 'tower',
});
