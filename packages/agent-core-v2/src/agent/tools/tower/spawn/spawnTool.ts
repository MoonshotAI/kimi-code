 ...
 *
 * Registered main-only (the tower) via the module-level
 * `registerAgentToolService(ITowerSpawnTool, TowerSpawnTool, …)` at the bottom
 * of this file. Bound at Agent scope.
 */
...
import {
  ...
  type TowerMission,
  type TowerState,
} from '#/agent/tower/protocol/index';
import { IAgentTowerService, TOWER_WORKER_PROFILE } from '#/agent/tower/tower';
...
registerAgentToolService(ITowerSpawnTool, TowerSpawnTool, {
  name: 'TowerSpawn',
  domain: 'tower',
