...
import { branchExists, branchTip } from '#/agent/tower/protocol/index';
import type { TowerMission, TowerState, TowerStore } from '#/agent/tower/protocol/index';
import { IAgentScopeContext } from '#/agent/scopeContext/scopeContext';
import { registerAgentToolService } from '#/agent/toolRegistry/toolContribution';
import {
  ITowerRateLimitService,
  type TowerRateLimitSnapshot,
} from '#/agent/tower/towerRateLimit';
...
registerAgentToolService(ITowerStatusTool, TowerStatusTool, {
  name: 'TowerStatus',
  domain: 'tower',
});
