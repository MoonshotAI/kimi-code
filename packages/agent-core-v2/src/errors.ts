...
import { WorkspaceContextErrors } from '#/session/workspaceContext/errors';
...
export { WorkspaceContextErrors } from '#/session/workspaceContext/errors';
