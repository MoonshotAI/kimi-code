...
import {
  ...
  type ThinkingDeps,
} from '#/actor/profile/internal/thinking';
import {
  buildSystemPromptContext,
  type SystemPromptCaches,
  type SystemPromptContextDeps,
} from '#/actor/profile/internal/systemPrompt';
import { publishToolPatternWarnings } from '#/actor/profile/internal/toolPatternWarnings';
import type {
  ApplyProfileOptions,
  BindAgentInput,
  ProfileData,
  ...
  SystemPromptContext,
} from '#/actor/profile/profile';
import { extractAgentsMdPathsFromSystemPrompt } from '#/actor/profile/profileContext';
import {
  ConfigUpdate,
  foldConfigUpdate,
  foldProfileBind,
...
import type { LoopControl } from '#/actor/loop/configSection';
