...
import type { AgentTaskInfo, AgentTaskNotificationContext } from './types';
...
export const taskRegistryTransition: StateFold<TaskModelState> = (s, e, ctx) => {
  if (e instanceof TaskStarted) {
