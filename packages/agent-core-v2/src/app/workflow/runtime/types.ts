/**
 * `workflow` domain (L6) — Dynamic Workflows core types (engine-agnostic).
 *
 ...
 * injected interface implemented by the Session-scope run service. Pure types
 * and constants — no scoped state.
 */
