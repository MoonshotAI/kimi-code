/**
 * `workflow` domain (L6) — workflow runtime (engine-agnostic).
 *
 * Executes a compiled workflow script against an injected subagent host,
 * enforcing concurrency/call/duration limits and cooperative cancellation.
 *
