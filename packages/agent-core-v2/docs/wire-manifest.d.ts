...
//   context.append_message             contextMemory, environmentBinding, plan, task.notificationDelivery        src/agent/contextMemory/contextEvents.ts
//   context.apply_compaction           contextMemory, environmentBinding, plan, task.notificationDelivery, turn  src/agent/contextMemory/contextEvents.ts
//   context.clear                      contextMemory, environmentBinding, plan, task.notificationDelivery, turn  src/agent/contextMemory/contextEvents.ts
//   context.undo                       contextMemory, environmentBinding, plan, task.notificationDelivery, turn  src/agent/contextMemory/contextEvents.ts
...
/**
 * states: contextMemory, environmentBinding, plan, task.notificationDelivery · blobs: contextMemory
 * owner: src/agent/contextMemory/contextEvents.ts
 */
...
/**
 * states: contextMemory, environmentBinding, plan, task.notificationDelivery, turn · blobs: contextMemory
 * owner: src/agent/contextMemory/contextEvents.ts
