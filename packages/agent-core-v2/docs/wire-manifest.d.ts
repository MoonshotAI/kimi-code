...
//   context.append_message             contextMemory, goalForkNotice, monitor.notificationDelivery, plan, task.notificationDelivery, todo  src/agent/contextMemory/contextEvents.ts
//   context.apply_compaction           contextMemory, monitor.notificationDelivery, plan, task.notificationDelivery, todo                  src/agent/contextMemory/contextEvents.ts
//   context.clear                      contextMemory, monitor.notificationDelivery, plan, task.notificationDelivery, todo                  src/agent/contextMemory/contextEvents.ts
//   context.undo                       contextMemory, monitor.notificationDelivery, plan, task.notificationDelivery, todo                  src/agent/contextMemory/contextEvents.ts
...
/**
 * states: contextMemory, goalForkNotice, monitor.notificationDelivery, plan, task.notificationDelivery, todo · blobs: contextMemory
 * owner: src/agent/contextMemory/contextEvents.ts
 */
interface ContextAppendMessagePayload {
  ...
  message: {
    ...
    origin?: 'user' | 'skill_activation' | 'plugin_command' | 'injection' | 'shell_command' | 'compaction_summary' | 'system_trigger' | 'task' | 'monitor' | 'cron_job' | 'cron_missed' | 'hook_result' | 'retry' | undefined;
    isError?: boolean;
    note?: string;
  };
}
...
/**
 * states: contextMemory, monitor.notificationDelivery, plan, task.notificationDelivery, todo · blobs: contextMemory
 * owner: src/agent/contextMemory/contextEvents.ts
...
interface TurnPromptPayload {
  ...
  /** PromptOrigin */
  origin: 'user' | 'skill_activation' | 'plugin_command' | 'injection' | 'shell_command' | 'compaction_summary' | 'system_trigger' | 'task' | 'monitor' | 'cron_job' | 'cron_missed' | 'hook_result' | 'retry';
}
