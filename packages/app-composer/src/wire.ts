...
// message-side classification, clipboard transforms, and the attachment
// metadata registry (DOM-free plugin). The contract is this package's
// docs/wire-format.md, pinned by its corpus + exhaustive matrix tests.
export * from './composerTextDoc';
export * from './mentionLinkPath';
export * from './skillActivationEdit';
export * from './attachmentRegistry';
