export default {
  ...
  canaryTriggerConfirm: '再点一次确认触发',
  canaryTriggerDone: '已触发，构建约需 20–30 分钟',
  canaryTriggerFailed: '触发失败：{error}',
  canaryViewWorkflow: '查看流水线',
  privacy: '数据与隐私',
  diagnostics: '诊断',
  messageFolding: '消息折叠',
  turnFolding: '消息自动折叠',
  turnFoldingHint: '回合结束时自动折叠工作过程，仅展示总结',
  activityRunFolding: '工具调用汇总',
  activityRunFoldingHint: '回答过程中，连续的工具调用自动汇总为一行摘要',
  build: '构建',
  serverVersion: '服务端版本',
  serverAddress: '服务器地址',
