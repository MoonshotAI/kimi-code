export default {
  ...
  vibrancyHint: 'Use the native macOS frosted-glass material behind the sidebar — turn it off if the translucency is hard to read',
  ...
  updateCheckAvailableAuto: 'Version {version} found — downloading in the background',
  ...
  canaryTriggerConfirm: 'Click again to confirm',
  canaryTriggerDone: 'Triggered — the build takes about 20–30 minutes',
  canaryTriggerFailed: 'Failed to trigger: {error}',
  canaryViewWorkflow: 'View workflow',
