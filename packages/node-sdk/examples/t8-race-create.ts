...
import { createLocalKimiHarness, type KimiHarness } from '@moonshot-ai/kimi-code-sdk';
...
const harnessA = createLocalKimiHarness({ identity, homeDir });
const harnessB = createLocalKimiHarness({ identity, homeDir });
