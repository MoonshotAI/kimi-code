/**
 * Built-in agent profiles — local port of the retired
 * `agent-core/profile/default`. The YAML/markdown resources are inlined via
 * Vite's `?raw` (tsdown's raw-text plugin bundles them for the SDK).
 */
